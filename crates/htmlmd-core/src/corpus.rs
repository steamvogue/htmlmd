...
//! Deterministic synthetic benchmark/test corpus.
//!
//! Shared by the criterion bench, the differential parity tests, and the
//! cross-tool comparison harness (`examples/dump_corpus.rs`) so every
//! consumer converts identical bytes. Doc-hidden: not part of the public API
//! contract.
...
pub fn generate_wiki_doc() -> String {
...
pub fn generate_news_doc() -> String {
...
pub fn generate_docs_doc() -> String {
...
pub fn generate_table_doc() -> String {
