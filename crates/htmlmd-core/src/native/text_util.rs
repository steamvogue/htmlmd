...
//! Text and whitespace utilities ported verbatim from htmd's `text_util.rs`.
//! These implement the whitespace-collapsing semantics that byte-parity with
//! htmd depends on; do not "fix" or simplify them.
